...
public abstract class chooseDiffucultyBase extends AnchorPane {
    ...
    public chooseDiffucultyBase() {
        ...
        imageView.setImage(new Image(getClass().getResource("../../../../../../picture/igre.jpg").toExternalForm()));

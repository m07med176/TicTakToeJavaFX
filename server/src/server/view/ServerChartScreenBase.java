...
public abstract class ServerChartScreenBase extends AnchorPane {
    ...
    public ServerChartScreenBase() {
        ...
        charts_btn.setOnAction(this::sCharts);
    ...
    protected abstract void sHome(javafx.event.ActionEvent actionEvent);

    protected abstract void sPlayers(javafx.event.ActionEvent actionEvent);

    protected abstract void sCharts(javafx.event.ActionEvent actionEvent);

 ...
 * @author Ahmed
 */
public class GameBoardControllerHardMode extends GameBoardScreenBase{
    int count =0;
    ArrayList arrlist=new ArrayList();
    ArrayList arrlistButtons=new ArrayList();
    private Stage stage;

    public GameBoardControllerHardMode(Stage stage) {
        this.stage = stage;
        addbuttonInList();
    }
...
playVideo();
   ...
   btn_Game_nine.setDisable(true);
    ...
    void random(){
       ...
       TicTacToeAIHard AiHard=new TicTacToeAIHard();
                 int index =AiHard.GenerateMove(-2);
